...
@InputType()
class RepositoryUpdateManyWithoutGitIntegrationsInput {
...
export { RepositoryUpdateManyWithoutGitIntegrationsInput as RepositoryUpdateManyWithoutGitIntegrationsInput };
