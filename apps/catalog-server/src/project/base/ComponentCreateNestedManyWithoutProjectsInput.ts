...
@InputType()
class ComponentCreateNestedManyWithoutProjectsInput {
...
export { ComponentCreateNestedManyWithoutProjectsInput as ComponentCreateNestedManyWithoutProjectsInput };
