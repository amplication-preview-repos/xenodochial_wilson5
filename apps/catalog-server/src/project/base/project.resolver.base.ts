...
export class ProjectResolverBase {
  ...
  @graphql.ResolveField(() => [ProjectEnvironment], {
  ...
  async findProjectEnvironments(
    ...
    const results = await this.service.findProjectEnvironments(parent.id, args);
  ...
  async getAccount(@graphql.Parent() parent: Project): Promise<Account | null> {
