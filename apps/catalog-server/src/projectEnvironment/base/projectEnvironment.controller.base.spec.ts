...
const service = {
  ...
  projectEnvironments: () => FIND_MANY_RESULT,
  projectEnvironment: ({ where }: { where: { id: string } }) => {
    switch (where.id) {
      case existingId:
...
describe("ProjectEnvironment", () => {
  ...
  test("POST /projectEnvironments", async () => {
    await request(app.getHttpServer())
      .post("/projectEnvironments")
      .send(CREATE_INPUT)
  ...
  test("GET /projectEnvironments", async () => {
    await request(app.getHttpServer())
  ...
  test("GET /projectEnvironments/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/projectEnvironments"}/${nonExistingId}`)
  ...
  test("GET /projectEnvironments/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/projectEnvironments"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /projectEnvironments existing resource", async () => {
